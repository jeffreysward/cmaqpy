#!/bin/csh -f
#SBATCH -J ptertac_onetime		# Job name
%SLURM%
#SBATCH -o out_ptertac_onetime.%j		# Name of stdout output file (%j expands to jobId) 
...
mv out_ptertac_onetime* $IMD_ROOT/ptertac/logs/
