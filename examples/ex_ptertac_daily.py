...
smoke_sim = SMOKEModel(appl, grid_name, sector='ptertac', run_months=[8], ertac_case='CONUS2016_Base',
    ...
    setup_yaml=f'dirpaths_{appl}.yml', compiler='gcc', compiler_vrsn='9.3.1', verbose=True)
