...
/usr/bin/python /home/jas983/models/ertac_egu/ertac_v2.1.1/ertac_for_smoke.py --input-prefix-pre=outputs/ --input-prefix-proj=outputs/${CASE}p_ --input-prefix-fs=ERTAC_for_SMOKE_extra_inputs/FS_CONUSv16.0_2023_1810002_ --input-prefix-pp=${CASE}post_results/ -o ${CASE}fs_
